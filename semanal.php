    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function gerarCalendarioSemanal(dataBase) {
                ...
                // Calcula o fim da semana (Sábado) - REMOVIDO POIS NÃO É MAIS USADO NO TÍTULO
                // const fimSemana = new Date(inicioSemana);
                // fimSemana.setDate(inicioSemana.getDate() + 6);

                // *** ÚNICA ALTERAÇÃO FEITA ***
                // Define o título do cabeçalho para mostrar o Mês e o Ano
                // Usamos a 'dataBase' como referência.
                const formatadorTitulo = { month: 'long', year: 'numeric' };
